...
--print(coroutine.running())
	--impro={}
	impro.trainee=graphics.newImageSheet("batiment/projectiles/trainee.png",{width=194,height=62,numFrames=1,sheetContentWidth=194,sheetContentHeight=62})
	impro.flechepluie=graphics.newImageSheet( "batiment/projectiles/flechepluie.png", { width=17, height=35, numFrames=3,sheetContentWidth=17,sheetContentHeight=105 } )
	coroutine.yield()
	impro.meteorite=graphics.newImageSheet( "batiment/projectiles/meteorite.png", { width=53, height=127, numFrames=2,sheetContentWidth=106,sheetContentHeight=127 } )
	...
	impro.poussiere=graphics.newImageSheet("AnimVF/ondechoc.png",{width=512,height=352,numFrames=1}) --graphics.newImageSheet("AnimVF/ombresld.png",{width=20,height=8,numFrames=1,sheetContentWidth=20,sheetContentHeight=8})
	impro.explosion=graphics.newImageSheet("AnimVF/explosion.png",{width=64,height=64,numFrames=8})
	impro.explosionseq={
		name="explosion",
    	frames={1,2,3,4,5,6,7,8,7,8,7,8,7},--frames= {1,4,5,3}, -- frame indexes of animation, in image sheet
    	time = 500,
	...
	impro.liquide={}
	impro.liquide.bat1=graphics.newImageSheet( "batiment/projectiles/projectiles.png", { width=194, height=62, numFrames=7,sheetContentWidth=194,sheetContentHeight=434 } )
	...
	coroutine.yield()
	imageecha=graphics.newImageSheet( "batiment/echafaudage1.png", { width=570, height=519, numFrames=5,sheetContentWidth=1710,sheetContentHeight=1038 } )

	imaanim={}
	local indiceimaanim=1
	imaanim[indiceimaanim]={}
	imaanim[indiceimaanim].sheet=graphics.newImageSheet( "carte/animg/oiseau.png", { width=65, height=71, numFrames=4 } )
	...
	imaanim[indiceimaanim]={}
	imaanim[indiceimaanim].sheet=graphics.newImageSheet( "carte/animg/corbeau.png", { width=48, height=46, numFrames=4 } )
	...
	indiceimaanim=indiceimaanim+1
	imaanim[indiceimaanim]={}
	imaanim[indiceimaanim].sheet=graphics.newImageSheet( "carte/animg/vautour.png", { width=45, height=49, numFrames=4 } )
